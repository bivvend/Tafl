...
namespace Tafl.AI
{
    public class SimpleSquare
    {
        ...
        public Square.occupation_type Occupation
        {
            ...
            {
                occupation = value;
                if (value == Model.Square.occupation_type.Attacker)
                {
                    KingPresent = false;
                    AttackerPresent = true;
                    DefenderPresent = false;
                }
                if (value == Model.Square.occupation_type.Defender)
                {
                    KingPresent = false;
                    AttackerPresent = false;
                    DefenderPresent = true;
                }
                if (value == Model.Square.occupation_type.King)
                {
                    KingPresent = true;
                    AttackerPresent = false;
                    DefenderPresent = false;
                }
                if (value == Model.Square.occupation_type.Empty)
                {
                    KingPresent = false;
                    AttackerPresent = false;
                    DefenderPresent = false;
